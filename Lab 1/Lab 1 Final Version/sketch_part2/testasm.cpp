...
__attribute__((used)) unsigned int sumval(unsigned char a, unsigned char b)
{
   unsigned int out;
...
__attribute__((used)) unsigned int diffval(unsigned char a, unsigned char b)
{
   unsigned int out;
...
__attribute__((used)) unsigned int ourMain(unsigned char a, unsigned char b)
{
   unsigned int out;
